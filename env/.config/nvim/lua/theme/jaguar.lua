local M = {}
local config = require("theme.jaguar.config")

local function set_highlights()
	local utilities = require("theme.jaguar.utilities")
	local palette = require("theme.jaguar.palette")
	...
	if config.options.enable.terminal then
		...
		augroup jaguar
			...
			autocmd ColorSchemePre * autocmd! jaguar
		augroup END
		]])
	end
end
...
vim.api.nvim_create_user_command("Jaguar", function()
	M.colorscheme()
end, {})

-- Create a global function that can be called by :colorscheme
_G.jaguar_colorscheme = function()
	M.colorscheme()
end
